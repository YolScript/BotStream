...
module.exports = {
  ...
  polling: {
    ...
    twitchClipsMs: parseInt(process.env.TWITCH_CLIPS_POLL_INTERVAL_MS, 10) || 300000,
    youtubeVideosMs: parseInt(process.env.YOUTUBE_VIDEOS_POLL_INTERVAL_MS, 10) || 300000,
    tiktokVideosMs: parseInt(process.env.TIKTOK_VIDEOS_POLL_INTERVAL_MS, 10) || 300000,
